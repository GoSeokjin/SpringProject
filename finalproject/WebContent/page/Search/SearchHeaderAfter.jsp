		...
		<div class="container">
				...
				<form class="navbar-form navbar-left" role="search"
					...
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Search"
							name="searchWord" <%if (search != null) {%>
			...
			<div id="navbar" class="collapse navbar-collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a
						href="contentLayout.jsp?body=../page/mypage/mypageProfile.jsp&side=../page/mypage/mypageSide.jsp">마이페이지</a></li>
					<li><a href="<%=realPath%>/page/Join/LogoutOk.jsp">로그아웃</a></li>
				</ul>
			</div>
		</div>
		</nav>
